...
- [任务开发指南](docs/README.md) - 详细的API文档和开发规范
...
底层接口
先封装完底层的接口，比如说识图，OCR识别，YOLO。每一个都封装成一个类，并且支持多线程并发调用。可以单元化测试

自动化机器人类
有开始，停止，暂停，终止，设置，获取状态等接口

这个机器人就负责调用我们的自动化任务，每一个任务通过一个基类来设计。只需要将包含机器人资源的上下文给每一个任务。

监控中心类，
监控每个机器人是否卡死，卡死就重启。
负责启动，关闭机器人，可以创建多少个机器人同时工作
---
